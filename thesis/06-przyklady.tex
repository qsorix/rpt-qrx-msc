...
\FIXME{Tutaj jakoś przedstawić wyniki z bazy danych.}
...
dyspozycji szczegółowe dane na temat każdej z wykonanych komend. Zarówno komendy
przygotowujące, jak i te uruchomiane zgodnie z planem testu, posiadają wyjście,
...
połączone routerem sztucznie generującym opóźnienia.}

\FIXME{Różne sytuacje, tu opiszemy taką...}
