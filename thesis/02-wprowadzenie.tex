...
\begin{itemize}
  \item{wymienianych Protocol Data Unit\footnote{\emph{Czy wszędzie indziej też
...
specyfikacją\footnote{\emph{Coś tutaj było nie tak z tym zdaniem, ale nie umiem
...
położenie bitów w pakiecie) określone są w tym samym miejscu\footnote{\emph{Co
...
OMNeT++ to biblioteka i framework\footnote{\emph{Postanowiliśmy zdecydowanie
