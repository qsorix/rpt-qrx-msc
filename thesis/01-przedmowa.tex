...
\FIXME{W powyższym akapicie dopisać, że takie rozwiązanie nie istaniało.}
...
\FIXME{W sumie to testowanie jest tematem pracy, napisać to inaczej.}
...
\FIXME{Powiększyć ten dział o inne pojęcia i skróty, żeby miał sens:)}
