...
będącą częścią mechanizmu powiadomień (patrz sekcja \ref{arete-master-others}).
Pozwala on na wysyłanie powiadomień w dowolnym momencie testu przez uruchamiane
w jego ramach komendy, korzysta się z wyrażenia \code{@\{poke <nazwa
powiadomienia>\}}.
...
przypadku korzystania z mechanizmu powiadomień (patrz sekcja \ref{arete-master-others}).}
