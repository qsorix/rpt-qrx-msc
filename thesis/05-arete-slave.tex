...
\paragraph{Poker} realizuje funkcję \emph{poke}\footnote{\emph{ang. poke} -
...
będącą częścią mechanizmu powiadomień (Rozdział \fixref{Mechanizm
Powiadomień}).  Pozwala on na wysyłanie powiadomień w dowolnym momencie testu
przez uruchamiane w jego ramach komendy, korzysta się z wyrażenia 
\code{@\{poke <nazwa powiadomienia>\}}.
