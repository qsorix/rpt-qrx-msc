...
\FIXME{
Podzielić ten rozdział na mniejsze - mniej pojemne. Nadać mu jakąś konkretną nazwę.
}
...
\FIXME{
Bardziej ogólnie. Dla testerów, zespołów badawczych...
...
\FIXME{
Znowy przyczepiłeś się do laboratorium i sieci akademickiej.
...
\FIXME{
Opisać to mniej ogólnie na przykładzie naszego programu. Jak już ponazywamy
wszystko. + Przykład na koniec.
...
\FIXME{
Znowu problem z 'urządzeniami'.

\paragraph{O urządzeniach zakładamy jak najmniej.} Program NAZWA nie wymaga od
urządzeń biorących udział w teście żadnej funkcjonalności. Dzięki temu jesteśmy
w stanie obsługiwać zarówno tanie urządzenia sieciowe, o bardzo ograniczonych
możliwościach konfiguracyjnych, jak i w pełni wyposażone systemu Uniksowe czy
dedykowane routery. To użytkownik decyduje o tym, co w danym teście mają robić
występujące w nim urządzenia i tym samym stawia im wymagania. Zarówno te
dotyczące funkcjonalności, jak i bezpieczeństwa.
}
