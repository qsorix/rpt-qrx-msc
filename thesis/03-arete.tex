...
\FIXME{Opisać fazy testu (check -- tę nazywam w treście fazą przygotowania,
setup -- a tę fazą konfiguracji, ...). Może słabo te nazwy dobrałem, trzeba
jakieś ładne polskie odpowiedniki dobrać.}
