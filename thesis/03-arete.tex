...
\FIXME{Cz.: jakoś wyróżnijcie te scenariusze – nie widać, giną w tekście.}
...
\FIXME{Cz.: „zakładając symetryczny czas” – kiedy to założenie nie będzie
spełnione? Czy jego przyjęcie jest akceptowalne?}
...
\FIXME{Cz.: zegary urządzeń prawdopodobnie
będą zsynchronizowane dokładniej – NTP daje dokładność kilku MS, więc
