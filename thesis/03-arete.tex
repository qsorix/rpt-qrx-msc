...
\FIXME{Napisać bardziej szczegółowo co będzie dalej opisywane...}
...
\FIXME{Może by te scenariusze jakoś wypunktować. Napisać gdzieś, że są to
przykłady które mają swoje pliki w ./examples i są dołączone do pracy, bo nie
do końca wiadomo czemu są takie szczegółowe (ls, md5sum)}
...
ze względów bezpieczeństwa. \fixme{Program nadzorujący umożliwia również
...
\FIXME{Rysunek architektury całego systemu jest potrzebany! Ogólnie tutaj dobrze to opisać.}
