...
\begin{center}
\leavevmode
\includegraphics[width=0.8\textwidth]{arete-deploy}
\end{center}
...
\begin{center}
\leavevmode
\includegraphics[width=0.8\textwidth]{arete-test-sequence-deploy}
\end{center}
...
\begin{center}
\leavevmode
\includegraphics[width=0.8\textwidth]{arete-test-sequence-test}
\end{center}
...
\begin{center}
\leavevmode
\includegraphics[width=0.8\textwidth]{arete-test-sequence-trigger}
\end{center}
...
\begin{center}
\leavevmode
\includegraphics[width=0.8\textwidth]{arete-test-sequence-results}
\end{center}
