...
Wybór tego Pythona był podyktowany jego popularnością, mamy więc nadzieję, że
spora część użytkowników odbierze to założenia jako zaletę, a nie wadę
produktu. Kolejnym plusem jest to, że jest on dostępny na wszystkich popularnych
