...
\FIXME{Wstęp do rozdziału}

%W tym rozdziale prezentujemy stworzone przez nas narzędzie Arete – Auto-
%mated Real Environment Testing Engine. Jego zadaniem jest automatyzacja
...
%Omówienie rozpoczynamy od przedstawienia, popartych przykładami, zastoso-
%wań, z myślą o których stworzone zostało Arete. Są to sytuacje, w których nasze
%narzędzie pozwoli usprawnić pracę osób przeprowadzających testy.
%Następnie opisujemy wynikające z zastosowań wymagania funkcjonalne. Wyma-
%gania te krótko podsumowują podstawowe możliwości programu.
%W dalszej części prezentujemy dodatkowe założenia mające wpływ na charakter
%tworzonego rozwiązania, jednocześnie argumentując podjęte przez nas decyzje
%w świetle jego użyteczności.
...
korzystać z haseł. \fixme{W opisie konfiguracji chyba nie ma słowa o
parametrach.}
