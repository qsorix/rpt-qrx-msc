...
dziesiątek ms w sieciach WAN do nawet 50 µs w sieciach LAN przy zastosowaniu
odbiorników GPS lub innych dokładnych źródeł czasu. Trzeba też pamiętać, że
wpływ ma tutaj także planista systemowy, który może powodować opóźnienia w
wykonywaniu programów.
