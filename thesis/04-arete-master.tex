...
\code{RunPolicy}. Użytkownik może definiować własne strategie -- patrz
...
algorytm synchronizacji wtyczki \code{AreteSlavePlugin}. Dokładność uzyskiwana
przy użyciu NTP jest zależna od wersji protokołu, zastosowanego sprzętu,
systemu operacyjnego i rodzaju sieci \cite{ntp-research} i może wynosić od
...
\ref{reference:interfejs-programy}.  Tutaj dodamy jeszcze tylko, że sterowniki
